    ...
    <div className='flex items-center justify-between font-medium py-5'>
        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
            <NavLink to='/' className='flex flex-col items-center gap-1'>
                <p>HOME</p>
                <hr className='w-2/4 border-none h-[1.5px] text-gray-700'/>
            </NavLink>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${isVisible? 'w-full':'w-0'}`}>
            <div className='flex flex-col text-gray-600'>
                ...
                <NavLink className='py-2 pl-6 border border-gray-400'onClick={()=>setisVisible(false)} to='/'>HOME</NavLink>
                <NavLink className='py-2 pl-6 border border-gray-400'onClick={()=>setisVisible(false)} to='/collection'>COLLECTION</NavLink>
                <NavLink className='py-2 pl-6 border border-gray-400'onClick={()=>setisVisible(false)} to='/about'>ABOUT</NavLink>
