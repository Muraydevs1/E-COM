...
function Collection() {
  ...
  const toggleCategory = (e)=>{
    ...
    const sortProduct = ()=>{
      let copyFilterProduct = filterProducts.slice();
      switch(sortType){
        case 'low-high':
          setfilterProducts(copyFilterProduct.sort((a,b)=>(a.price - b.price)));
          break;
        
        case 'high-low':
          setfilterProducts(copyFilterProduct.sort((a,b)=>(b.price -a.price)))
          break;
